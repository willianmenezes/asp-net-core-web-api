...
namespace DevIO.Apio.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        public AuthController(INotificador notificador,
                              ...
                              IOptions<AppSettings> appSertings, IUser user) : base(notificador, user)
        {
            _signInManager = signInManager;
            _userManager = userManager;
            _appSettings = appSertings.Value;
        }
        ...
        public async Task<ActionResult> Login(LoginUserViewModel loginUser)
        {
            ...
            {
                NotificarErro("Usuário temporariamente bloqueado por conta de tentativas invalidas");
        ...
        private async Task<LoginResponseViewModel> GerarJwt(string email)
        {
            ...
            claims.Add(new Claim(JwtRegisteredClaimNames.Iat, ToUnixEpocheDate(DateTime.UtcNow).ToString(), ClaimValueTypes.Integer64));
        ...
        private static long ToUnixEpocheDate(DateTime dateTime)
